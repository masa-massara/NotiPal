...
export interface ListNotionDatabasesOutput
	extends Array<NotionDatabaseOutputItem> {}
...
export interface GetNotionDatabasePropertiesOutput
	extends Array<NotionPropertyOutputItem> {}
